...
public class RecruitActivity extends BaseActivity {
    ...
    private Recruit_information information;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        information = (Recruit_information)getIntent().getSerializableExtra("Recruit_information");
        initView();
        initData();
        tv_report.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(RecruitActivity.this);
    ...
    private void initData() {
        utils = new BitmapUtils(RecruitActivity.this);
        //设置加载过程中的默认图片
        utils.configDefaultLoadingImage(R.mipmap.image7);

        utils.display(iv_activity,information.getActivity_image().getFileUrl());
        tv_theme.setText(information.getAddress()+"义工招幕");
        tv_time.setText(information.getGather_time());
        tv_address.setText(information.getGather_address());
        tv_ph.setText(information.getMy_phone());
    ...
    public void click2(View v) {
        final EditText input = new EditText(RecruitActivity.this);
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(RecruitActivity.this,"报名成功，请等待审核",Toast.LENGTH_SHORT).show();
            }
        });
        builder.show();
    }
